...
exports.partials = function(data){
  partials = data;
};
...
exports.helpers = function(data){
  helpers = data;
};

/**
 * Merge default options with express options
 *
 * @param {Object} options
 * @return {Object}
 * @api private
...
function mergeOptions(options) {
  ...
  // merge express options in default options
...
function readPartials(path, options, fn) {
  if (!partials) return fn();
  var keys = Object.keys(partials);

  // Reset options partials
